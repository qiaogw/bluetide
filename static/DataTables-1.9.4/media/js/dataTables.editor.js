			...
			'<div class="'+classes.wrapper+'">'+
				...
				'<div data-dte-e="body" class="'+classes.body.wrapper+'">'+
					'<div data-dte-e="body_content" class="'+classes.body.content+'">'+
						...
						'<br clear="all" />'+
						'<div id="table_vasPhoto_uploads_Status" align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black; line-height:5px;"></div>'+
...
//						'<div style="padding:1px; padding-top:18px;float:right;font-family:Alef, Geneva, sans-serif; font-size:15px; color:black; width:150px;" align="right"></div>'+
//						'<div style="padding:1px;float:left; font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black; width:150px;" align="left">'+
...
fieldTypes.date = $.extend( true, {}, baseFieldType, {
	...
	"create": function ( conf ) {
		...
		if ( ! conf.dateImage ) {
			conf.dateImage = "/static/DataTables-1.9.4/media/images/calender.png";
		}
...
//		}
		...
		if ( ! conf.datetimeImage ) {
			conf.datetimeImage = "/static/DataTables-1.9.4/media/images/calender.png";
		}
...
//                showSecond: true,
//                showMillisec: true,
                buttonImage: conf.datetimeImage,
				buttonImageOnly: true,
                timeFormat: 'HH:mm:ss' ,
                regional: "zh-cn"
			});
	...
	"get": function ( conf, val ) {
		conf._input.datetimepicker( "getDate" , val );
	},

	"enable": function ( conf ) {
		conf._input.datetimepicker( "enable" );
	},

	"disable": function ( conf ) {
		conf._input.datetimepicker( "disable" );
	}
} );
